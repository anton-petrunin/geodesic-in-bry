...
In particular, if $\dim M\ge 3$ and $\mathfrak{C}$ is bounded by a smooth hypersurface, then it is strictly convex; that is, all boundary points of $\mathfrak{C}$ are extreme.
\end{thm}
