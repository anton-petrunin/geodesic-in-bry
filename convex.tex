...
%\footnote{Can we weaken the reference to your proof in mathover flow as done now below?}
...
In fact the main part of the key lemma follows {\color{red} from} %the result in 
\cite{Petruninpar}.
...
%Let us use parallel translation along $\gamma$ to 
...
Let $\mathfrak{C}$ be a closed convex set in an arbitrary Riemannian manifold $(M,g)$ and $\gamma$ be a geodesic in the boundary of $\mathfrak{C}$ %equipped 
